    ...
    <head>
        ...
        <style>
            ...
            *,::backdrop,::after,::before{box-sizing:border-box;border-width:0;border-style:solid;border-color:oklch(.922 0 0)}:host,html{line-height:1.5;-webkit-text-size-adjust:100%;tab-size:4;font-family:ui-sans-serif,system-ui,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji;font-feature-settings:normal;font-variation-settings:normal;-webkit-tap-highlight-color:transparent}body{margin:0;line-height:inherit}
            ...
            @media(max-width:639px){.lp-hero{min-height:100vh;min-height:100svh}.lp-hero-content{padding:2.5rem 1rem}.lp-hero-h1{font-size:clamp(2rem,8vw,3rem)}.lp-hero-desc{font-size:.9375rem}.lp-btn-hero-primary,.lp-btn-hero-outline{padding:.75rem 1.5rem;font-size:.9375rem}.lp-hero-stats{padding:1rem 1.25rem;gap:1rem}.lp-hero-stat-number{font-size:1.5rem}.lp-hero-stat-divider{display:none}.lp-hero-scroll-hint{width:44px;height:44px}.lp-mobile-toggle{width:44px;height:44px}.lp-mobile-menu{max-height:calc(100vh - 64px);overflow-y:auto}.lp-features,.lp-users,.lp-experience{padding:3rem 1rem}.lp-cta{padding:3.5rem 1rem}.lp-features-grid{grid-template-columns:1fr}.lp-feature-card{padding:1.25rem}.lp-user-card{padding:1.25rem}.lp-experience-grid{grid-template-columns:1fr}.lp-experience-inner{gap:2rem}.lp-experience-card{padding:1.25rem}.lp-dashboard-stats{gap:.5rem}.lp-stat-pill{padding:.5rem}.lp-stat-pill-num{font-size:1rem}.lp-dashboard-achievements{flex-wrap:wrap}.lp-achievement-dot{width:32px;height:32px}.lp-btn-cta-primary{padding:.875rem 1.5rem;width:100%;justify-content:center}.lp-btn-cta-outline{padding:.875rem 1.5rem}}
            @keyframes lp-fade-up{from{transform:translateY(20px)}to{transform:translateY(0)}}.lp-admin-overlay{position:fixed;inset:0;z-index:100;background:rgba(0,0,0,.5);backdrop-filter:blur(4px);display:flex;align-items:center;justify-content:center;padding:1rem}.lp-admin-modal{position:relative;background:#fff;border-radius:16px;padding:2rem;width:100%;max-width:380px;box-shadow:0 20px 60px rgba(0,0,0,.25)}.lp-admin-close{position:absolute;top:.75rem;right:.75rem;background:none;border:none;font-size:1.5rem;color:#999;cursor:pointer;line-height:1;padding:.25rem}.lp-admin-close:hover{color:#333}.lp-admin-title{font-size:1.125rem;font-weight:700;color:#1b1b18;margin:0 0 .25rem}.lp-admin-desc{font-size:.8125rem;color:#706f6c;margin:0 0 1.25rem}.lp-admin-form{display:flex;flex-direction:column;gap:1rem}.lp-admin-field{display:flex;flex-direction:column;gap:.375rem}.lp-admin-label{font-size:.8125rem;font-weight:600;color:#1b1b18}.lp-admin-input{width:100%;padding:.625rem .75rem;border:1px solid #e2e8f0;border-radius:8px;font-size:.875rem;color:#1b1b18;background:#fff;outline:none;transition:border-color .2s,box-shadow .2s}.lp-admin-input:focus{border-color:#436391;box-shadow:0 0 0 3px rgba(67,99,145,.15)}.lp-admin-input::placeholder{color:#a0aec0}.lp-admin-error{font-size:.75rem;color:#e53e3e;margin:0}.lp-admin-btn{padding:.625rem;border-radius:10px;background:linear-gradient(135deg,#436391,#2d4f7a);color:#fff;font-size:.875rem;font-weight:600;border:none;cursor:pointer;transition:all .2s}.lp-admin-btn:hover{box-shadow:0 4px 14px rgba(67,99,145,.3)}.lp-admin-btn:disabled{opacity:.6;cursor:not-allowed}
            @elseif(str_starts_with($page['component'], 'auth/'))
            .auth-root{position:relative;height:100svh;display:flex;align-items:center;justify-content:center;overflow:hidden;background:linear-gradient(135deg,#F2DCDB,#F2AEBC 40%,#c9d8ed 75%,#436391)}.auth-bg-layer{position:absolute;inset:0;background:radial-gradient(ellipse 80% 60% at 20% 20%,rgba(242,174,188,.6),transparent 60%),radial-gradient(ellipse 60% 80% at 80% 80%,rgba(67,99,145,.35),transparent 60%),radial-gradient(ellipse 50% 50% at 50% 50%,rgba(242,220,219,.4),transparent 70%);pointer-events:none}.auth-content-wrapper{position:relative;z-index:10;width:100%;max-width:420px;padding:1.5rem;display:flex;flex-direction:column;align-items:center;gap:1.5rem}.auth-logo-link{display:flex;flex-direction:column;align-items:center;gap:.625rem;text-decoration:none}.auth-logo-ring{width:64px;height:64px;border-radius:18px;background:linear-gradient(135deg,#F2AEBC,#F2DCDB 50%,#c9d8ed);display:flex;align-items:center;justify-content:center;padding:4px;box-shadow:0 8px 32px rgba(67,99,145,.25),0 2px 8px rgba(242,174,188,.4)}.auth-logo-ring>svg{border-radius:12px;background:#fff;width:100%;height:100%;padding:8px}.auth-brand-name{font-size:.875rem;font-weight:600;color:#436391;letter-spacing:.03em;opacity:.85}.auth-glass-card{position:relative;width:100%;background:rgba(255,255,255,.85);-webkit-backdrop-filter:blur(8px);backdrop-filter:blur(8px);border-radius:24px;border:1px solid rgba(242,174,188,.45);box-shadow:0 20px 60px rgba(67,99,145,.12),0 4px 16px rgba(242,174,188,.15),inset 0 1px 0 rgba(255,255,255,.9);overflow:hidden}.auth-card-header{padding:2rem 2rem 0;text-align:center}.auth-title{font-family:system-ui,-apple-system,sans-serif;font-size:1.375rem;font-weight:700;color:#2d3748;letter-spacing:-.02em;margin:0 0 .375rem;line-height:1.3}.auth-description{font-family:system-ui,-apple-system,sans-serif;font-size:.8125rem;color:#718096;margin:0;line-height:1.5}.auth-card-body{padding:1.75rem 2rem 2rem}.auth-footer-text{font-size:.75rem;color:rgba(67,99,145,.7);text-align:center;margin:0}
            @endif
