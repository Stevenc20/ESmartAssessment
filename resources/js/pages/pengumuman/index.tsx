                ...
                <div className="mx-auto flex w-full max-w-7xl flex-col gap-6">
                    ...
                    {list.length > 0 ? (
                        <div className="space-y-3">
                            {list.map((item) => {
                                const cfg =
                                    typeConfig[item.type] ?? typeConfig.info;
                                const Icon = cfg.icon;
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="relative flex gap-4 px-5 py-4">
                                            <div
                                                className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-lg ${cfg.iconBg} ${cfg.iconColor}`}
                                            >
                                            ...
                                            <div className="min-w-0 flex-1">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <span
                                                        className={`inline-flex items-center rounded-full px-2 py-0.5 text-[10px] font-bold uppercase ${cfg.bg} ${cfg.sub}`}
                                                    >
                                                        {cfg.label}
                                                    </span>
                                                </div>
                                                <p
                                                    className={`mt-1 text-sm leading-relaxed ${cfg.sub}`}
                                                >
                                                    {item.isi}
                                                </p>
