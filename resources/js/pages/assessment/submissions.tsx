...
function SubmissionCard({
    ...
    const [isEditing, setIsEditing] = useState(
        !submission.nilai && submission.nilai !== 0,
    );
        ...
        <div className="px-5 py-4">
            <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
                <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-2">
                        ...
                        {submission.nilai != null && (
                            <span className="inline-flex items-center rounded-full bg-emerald-50 px-2 py-0.5 text-[10px] font-bold text-emerald-600 uppercase">
                    ...
                    <p className="mt-0.5 text-xs text-slate-500">
                        Revisi ke-{submission.revisi_ke} ·{' '}
                ...
                <div className="flex shrink-0 items-center gap-2">
                    {submission.file_tugas && (
                        <a
                            href={`/storage/${submission.file_tugas}`}
                            target="_blank"
            ...
            {isEditing && (
                <form
                    ...
                    className="mt-3 grid grid-cols-2 gap-3 rounded-lg bg-slate-50 p-4"
                >
                    <div>
