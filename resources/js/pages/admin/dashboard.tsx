    ...
    return (
        <div className="group relative min-h-[130px] overflow-hidden rounded-xl border border-[#e9edf3] bg-white p-5 transition-all hover:border-slate-300 hover:shadow-md">
            ...
            <div className="mt-2 flex items-baseline gap-2">
                ...
                {k.subtitle && (
                    <span className="text-xs text-slate-400">{k.subtitle}</span>
                )}
            </div>
            <div className="mt-1 flex items-center gap-1.5">
                <span
                    className={`inline-flex items-center text-xs font-semibold ${k.deltaUp ? 'text-emerald-600' : 'text-slate-400'}`}
                >
                    {k.deltaUp ? (
                        <svg
...
export default function SuperAdminDashboard({
    ...
    const secondaryKpis: KpiCard[] = [
        ...
        },
        {
            ...
            icon: UserCheck,
            color: '#22c55e',
            delta: String(stats.siswaAktif),
            deltaUp: true,
            subtitle: 'Sedang belajar',
        },
        {
            title: 'Siswa Non-aktif',
            value: stats.siswaTidakAktif,
            icon: UserMinus,
            color: '#ef4444',
            delta: '0%',
            deltaUp: false,
    ...
    const activities = [
        {
            label: 'Login',
            value: activityToday.login,
            icon: LogIn,
            color: '#3b82f6',
        },
        {
            label: 'Upload Tugas',
            value: activityToday.uploadTugas,
            icon: Upload,
            color: '#10b981',
        },
        {
            label: 'Materi Baru',
            value: activityToday.materiBaru,
            icon: BookOpen,
            color: '#f59e0b',
        },
        {
            label: 'Challenge',
            value: activityToday.challengeBaru,
            icon: Trophy,
            color: '#8b5cf6',
        },
    ];
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <div className="mb-1 flex flex-wrap items-center gap-2">
                                    <span className="inline-flex items-center gap-1 rounded-md bg-rose-50 px-2 py-0.5 text-[10px] font-bold tracking-wider text-rose-600 uppercase">
                                ...
                                <p className="mt-0.5 text-sm text-slate-500">
                                    Pantau seluruh aktivitas platform dalam satu
                                    layar
                                </p>
                            </div>
                        </div>
                                            ...
                                            <div className="h-7 flex-1 overflow-hidden rounded-md bg-slate-100">
                                                <div
                                                    ...
                                                    style={{
                                                        ...
                                                        background:
                                                            'linear-gradient(90deg, #436391, #5a7aaa)',
                                                    }}
                                                />
                                            </div>
