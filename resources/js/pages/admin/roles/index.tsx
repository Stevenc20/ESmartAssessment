...
return null;
                        ...
                        return (
                            <Dialog
                                open={true}
                                onOpenChange={() => setPermOpen(null)}
                            >
                                <DialogContent className="max-w-2xl">
                                    <DialogHeader>
                                        <DialogTitle>
                                            Hak Akses — {role.role_name}
                                        </DialogTitle>
                                    </DialogHeader>
...
RolesIndex.layout = {
    breadcrumbs: [
        ...
        { title: 'Role & Permission', href: '/admin/roles' },
    ],
};
