    ...
    return (
        <>
            ...
            <div
                ...
                style={{
                    background: 'linear-gradient(135deg, #F2AEBC 0%, #436391 100%)',
                }}
            >
            ...
            <div className="ml-1.5 grid flex-1 text-left group-data-[collapsible=icon]:hidden">
                <span
                    ...
                    style={{
                        background: 'linear-gradient(135deg, #436391 0%, #e8889a 100%)',
                ...
                <span className="text-[9px] font-medium tracking-wide text-muted-foreground/70 leading-tight">
                    Learn · Create · Grow
                </span>
            </div>
        </>
