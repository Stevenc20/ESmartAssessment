...
import { Activity, Archive, BookOpen, Calendar, CalendarDays, Database, LayoutGrid, Megaphone, Settings, Shield, Users } from 'lucide-react';
            ...
            <SidebarHeader className="px-4 py-4 group-data-[collapsible=icon]:px-2 group-data-[collapsible=icon]:py-1 transition-all duration-200">
                ...
                <div className="group-data-[collapsible=icon]:hidden px-1">
                    <div className="flex items-center gap-2">
                        <span className="h-2 w-2 rounded-full flex-shrink-0" style={{ background: '#7c3aed' }} />
                        <span className="text-xs font-medium" style={{ color: '#7c3aed' }}>Administrator</span>
                    </div>
                </div>
            </SidebarHeader>
