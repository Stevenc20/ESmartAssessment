        ...
        <>
            ...
            <div className="flex flex-col gap-4">
                <a href="/auth/google" className="block w-full">
                    <Button
                        type="button"
                        className="h-12 w-full rounded-lg border-2 border-gray-200 bg-white text-gray-700 shadow-md transition-all duration-200 hover:bg-gray-50 hover:shadow-lg"
                    >
                        <GoogleLogo />
