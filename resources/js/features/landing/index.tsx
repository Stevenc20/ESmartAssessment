...
export default function Welcome() {
    ...
    useEffect(() => {
        setTimeout(() => {
            document
                .querySelectorAll('.lp-hero-blob')
                .forEach((el) => el.classList.add('lp-anim-running'));
        }, 3000);
    }, []);
                ...
                >
                    <nav className="lp-nav-inner">
                        ...
                        <div className="lp-nav-links">
                            ...
                            <a href="#users" className="lp-nav-link">
                                Pengguna
                            </a>
                            <a href="#experience" className="lp-nav-link">
                                Pengalaman
                            </a>
                        </div>
                            ...
                            <div className="lp-mobile-cta">
                                {auth.user ? (
                                    <Link
                                        ...
                                        onClick={() => setMobileMenuOpen(false)}
                                    >
                                        <button className="lp-btn-primary w-full">
                                            Dashboard
                                        </button>
                                    </Link>
                                ) : (
                                    <>
                                        ...
                                        >
                                            <button className="lp-btn-outline w-full">
                                                Masuk
                                            </button>
                                        </Link>
                                        <a
